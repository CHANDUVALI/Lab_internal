...
def create_database():
    if connection():
        ...
        try:
            mycursor.execute("CREATE DATABASE db_181040015")
...
def create_table():
	conn_db=mysql.connector.connect(host="localhost",db="db_181040015",user="root",password="root")
...
def insert_values():
	db_conn=mysql.connector.connect(host="localhost",db="db_181040015",user="root",password="root")
